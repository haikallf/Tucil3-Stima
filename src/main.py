from astar import bacaTextFile, listOfNode, tetangga, coordinates, jarak, matrixJarakTetangga, getNeighbour, getIdx, sortingFn, closestPath, getMinFn, derivate
...
matrixDistTetangga = matrixJarakTetangga(arr, loc)
# 0 2 1
# 2 0 2
# 1 2 0
src = str(input("Masukkan node awal : ")) # A
dest = str(input("Masukkan node tujuan : ")) # G
jalan = closestPath(src, dest, arrNeigh, matrixDistTetangga, listNode) # [('A', 0), ('B', 20.62), ('G', 159.84)], elmt kedua dari tuple dalam satuan meter
print(jalan)